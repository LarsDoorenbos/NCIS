...
anchors = torch.from_numpy(np.load('./token_embed_c100.npy')).cuda()
...
train_data_in = torchvision.datasets.CIFAR100("../data/", train=True, transform=transform)
...
np.save \
        (f"embed_c100_images_clip_{args.offset}_{args.num_images}.npy", image_embeds)
