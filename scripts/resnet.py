...
def convnext_base(**kwargs):
    return ConvNext_features(torchvision.models.convnext_base(weights='IMAGENET1K_V1').cuda())


def vit_b16(**kwargs):
    return VIT_features(torchvision.models.vit_b_16(weights='IMAGENET1K_V1').cuda()) 
