...
ood_data = svhn.SVHN(root=OOD_PATH + 'svhn/', split="test",
...
# /////////////// Places365 ///////////////
ood_data = dset.ImageFolder(root=OOD_PATH + "places_test/",
...
# /////////////// LSUN-C ///////////////
ood_data = dset.ImageFolder(root=OOD_PATH + "LSUN",
...
# /////////////// iSUN ///////////////
ood_data = dset.ImageFolder(root=OOD_PATH + "iSUN",
                            transform=trn.Compose([trn.ToTensor(), trn.Normalize(mean, std)]))
ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.test_bs, shuffle=True,
                                         num_workers=1, pin_memory=True)
print('\n\niSUN Detection')
