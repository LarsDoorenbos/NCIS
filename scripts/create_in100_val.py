...
imgnet_val = datasets.ImageNet('/home/lars/Outliers/data/', split='val')
print(len(imgnet_val))
...
wn_ids = imgnet_val.wnids

for i in range(len(imgnet_val)):
    img = imgnet_val[i][0]
    img_id = wn_ids[imgnet_val[i][1]]

    if img_id in f1:
        print('Image {} belongs to class {}'.format(i, img_id))
        os.makedirs(f"/home/lars/Outliers/data/imgnet_val/{img_id}", exist_ok=True)
        img.save(f"/home/lars/Outliers/data/imgnet_val/{img_id}/{i}.JPEG")
