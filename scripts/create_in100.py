...
processed = 0
for ids, dirs in enumerate(os.listdir('/storage/workspaces/artorg_aimi/ws_00000/lars/imgnet_train')):
    for tg_class in f1:
        if tg_class in dirs:
            print('{} is transferred'.format(dirs))
            
            # Make directory in imgnet_100 folder
            os.makedirs('/storage/workspaces/artorg_aimi/ws_00000/lars/imgnet_100/{}'.format(tg_class), exist_ok=True)

            subprocess.run(['tar', '-xf', '/storage/workspaces/artorg_aimi/ws_00000/lars/imgnet_train/{}'.format(dirs), '-C', '/storage/workspaces/artorg_aimi/ws_00000/lars/imgnet_100/{}'.format(tg_class)])
